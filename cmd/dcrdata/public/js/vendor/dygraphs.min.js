          ...
          ;((r.prototype = new n.default()),
            (r.prototype.extractSeries = function (t, e, a) {
              for (var i, n, r, o = [], s = a.get('logscale'), l = 0; l < t.length; l++)
                ((i = t[l][0]),
                  (r = t[l][e]),
                  s && null !== r && (r[0] <= 0 || r[1] <= 0 || r[2] <= 0) && (r = null),
                  null !== r
                    ? ((n = r[1]),
                      null === n || isNaN(n)
                        ? o.push([i, n, [n, n]])
            ...
            (r.prototype.rollingAverage = function (t, e, a) {
              ...
              for (n = 0, o = 0, r = 0, s = 0, l = 0; l < t.length; l++) {
                if (
                  ...
                  (h = t[l][2]),
                  (u[l] = t[l]),
                  null === i || isNaN(i) || ((n += h[0]), (o += i), (r += h[1]), (s += 1)),
                  l - e >= 0)
                ) {
                  var d = t[l - e]
                  null === d[1] ||
      ...
      3: [
        function (t, e, a) {
          ...
          ;((r.prototype = new n.default()),
            (r.prototype.extractSeries = function (t, e, a) {
              for (
                var i, n, r, o, s = [], l = a.get('sigma'), h = a.get('logscale'), u = 0;
                u < t.length;
                u++
              )
                ((i = t[u][0]),
                  (o = t[u][e]),
                  h && null !== o && (o[0] <= 0 || o[0] - l * o[1] <= 0) && (o = null),
                  null !== o
                    ? ((n = o[0]),
                      null === n || isNaN(n)
                        ? s.push([i, n, [n, n, n]])
                        : ((r = l * o[1]), s.push([i, n, [n - r, n + r, o[1]]])))
            ...
            (r.prototype.rollingAverage = function (t, e, a) {
              ...
              for (i = 0; i < t.length; i++) {
                ...
                l
                  ...
                  : ((o = 1 == e ? t[i][1] : null), (c[i] = [t[i][0], o, [o, o]]))
              }
              return c
            }),
            (a.default = r),
        ...
        function (t, e, a) {
          ...
          ;((s.prototype = new o.default()),
            (s.prototype.extractSeries = function (t, e, a) {
              for (var i, n, r, o, s, l, h = [], u = a.get('logscale'), d = 0; d < t.length; d++)
                ((i = t[d][0]),
                  (r = t[d][e]),
                  ...
                  null !== r
                    ? ((o = r[0]),
                      ...
                      null === o || isNaN(o)
                        ? h.push([i, o, [o, s]])
                        : ((l = s ? o / s : 0), (n = 100 * l), h.push([i, n, [o, s]])))
          ...
          ;((s.prototype.clear = function () {
            ...
            (s._drawStyledLine = function (t, e, a, i, r, o, l) {
              ...
              var d = h.getBooleanOption('drawGapEdgePoints', t.setName),
                ...
                g = n.createIterator(
                  ...
                  0,
                  c.length,
                  s._getIteratorPredicate(h.getBooleanOption('connectSeparatedPoints', p))
                ),
                f = i && i.length >= 2,
                _ = t.drawingContext
            ...
            (s._drawSeries = function (t, e, a, i, n, r, o, s) {
              ...
              for (var _ = e.array_, v = e.end_, y = e.predicate_, x = e.start_; x < v; x++) {
                ...
                if (null === h.canvasy || h.canvasy != h.canvasy)
                  (o && null !== u && (f.moveTo(u, d), f.lineTo(h.canvasx, d)), (u = d = null))
                else {
                  if (((l = !1), r || null === u)) {
            ...
            (s._drawPointsOnLine = function (t, e, a, i, n) {
              for (var r = t.drawingContext, o = 0; o < e.length; o++) {
                var s = e[o]
                ;(r.save(),
                  a.call(t.dygraph, t.dygraph, t.setName, r, s[0], s[1], i, n, s[2]),
                  r.restore())
              }
            }),
            ...
            (s._linePlotter = function (t) {
              ...
              ;(r &&
                i &&
                s._drawStyledLine(t, e.getOption('strokeBorderColor', a), i + 2 * r, l, h, o, u),
              ...
              if (e.getBooleanOption('errorBars') || e.getBooleanOption('customBars')) {
                ...
                var i,
                  ...
                  d = n.createIterator(
                    ...
                    0,
                    u.length,
                    s._getIteratorPredicate(e.getBooleanOption('connectSeparatedPoints', a))
                  ),
                  c = NaN,
                  p = NaN,
                  g = [-1, -1],
                  ...
                  if (!(e.length <= 1)) {
                    ...
                    if (e.length > 2 && !t) {
                      ...
                      ;(e.splice(r, e.length - r),
                        o < s ? (e.push(h), e.push(u)) : o > s ? (e.push(u), e.push(h)) : e.push(h))
                    }
                  }
                },
                o = function (a) {
                    ...
                    if (e.getBooleanOption('fillGraph', y)) {
                      ...
                      var O,
                        ...
                        E = n.createIterator(
                          ...
                          0,
                          D.length,
                          s._getIteratorPredicate(e.getBooleanOption('connectSeparatedPoints', y))
                        ),
                        L = NaN,
                        T = [-1, -1],
                        S = n.toRGB_(b),
                      ...
                      for (var N, F = []; E.hasNext; )
                        if (((N = E.next()), n.isOK(N.y) || m)) {
                          ...
                          ;(isNaN(L)
                            ? (v.moveTo(N.canvasx, O[1]), v.lineTo(N.canvasx, O[0]))
                            : (m
                                ? (v.lineTo(N.canvasx, T[0]), v.lineTo(N.canvasx, O[0]))
                                : v.lineTo(N.canvasx, O[0]),
                              c &&
                                (F.push([L, T[1]]),
                                l && r ? F.push([N.canvasx, r[1]]) : F.push([N.canvasx, O[1]]))),
                            (T = O),
                            (L = N.canvasx))
                        } else
                          (f(v, L, T[1], F),
          ...
          ;((r.maybeTreatMouseOpAsClick = function (t, e, a) {
            ...
            (r.startPan = function (t, e, a) {
              ...
              if (
                (e.getOptionForAxis('logscale', 'x')
                  ...
                  : ((a.initialLeftmostDate = o[0]), (a.dateRange = o[1] - o[0])),
              ...
              for (a.is2DPan = !1, a.axes = [], i = 0; i < e.axes_.length; i++) {
                ...
                ;(e.attributes_.getForAxis('logscale', i)
                  ...
                  : ((m.initialTopValue = b[1]), (m.dragValueRange = b[1] - b[0])),
                  (m.unitsPerPixel = m.dragValueRange / (e.plotter_.area.h - 1)),
                  a.axes.push(m),
            ...
            (r.movePan = function (t, e, a) {
              ...
              if (
                ...
                e.getOptionForAxis('logscale', 'x')
                  ? (e.dateWindow_ = [Math.pow(n.LOG_SCALE, i), Math.pow(n.LOG_SCALE, r)])
                  : (e.dateWindow_ = [i, r]),
                a.is2DPan)
              )
                for (var o = a.dragEndY - a.dragStartY, s = 0; s < e.axes_.length; s++) {
                  ...
                  ;(d && p < d[0] && ((c -= p - d[0]), (p = c - h.dragValueRange)),
                    e.attributes_.getForAxis('logscale', s)
                      ? (l.valueRange = [Math.pow(n.LOG_SCALE, p), Math.pow(n.LOG_SCALE, c)])
                      : (l.valueRange = [p, c]))
                }
              e.drawGraph_(!1)
            }),
            ...
            (r.startTouch = function (t, e, a) {
              ...
              if (((a.initialTouches = i), 1 == i.length))
                ((a.initialPinchCenter = i[0]), (a.touchDirections = { x: !0, y: !0 }))
              else if (i.length >= 2) {
            ...
            mousedown: function (t, e, a) {
              if (!t.button || 2 != t.button) {
                ;(a.initializeMouseDown(t, e, a),
                  t.altKey || t.shiftKey ? r.startPan(t, e, a) : r.startZoom(t, e, a))
                var i = function (t) {
                    if (a.isZooming) {
                      s(t, e) < 100
                        ? r.moveZoom(t, e, a)
                        : null !== a.dragEndX &&
                          ((a.dragEndX = null), (a.dragEndY = null), e.clearZoomRect_())
        ...
        function (t, e, a) {
          ...
          ;((r.prototype.addDataset = function (t, e) {
            ...
            (r.prototype.computePlotArea = function () {
              var t = { x: 0, y: 0 }
              ;((t.w = this.dygraph_.width_ - t.x - this.dygraph_.getOption('rightGap')),
                ...
                for (var o = this.yAxes_[t], s = 0; s < o.ticks.length; s++)
                  ((e = o.ticks[s]),
                    ...
                    (i = this.dygraph_.toPercentYCoord(n, t)) > 0 &&
                      i <= 1 &&
                      this.yticks.push({ axis: t, pos: i, label: a, has_tick: r }))
            }),
      ...
      15: [
        function (t, e, a) {
          ;(function (i) {
            ...
            if (
              ((u.AXIS_STRING_MAPPINGS_ = { y: 0, Y: 0, y1: 0, Y1: 0, y2: 1, Y2: 1 }),
              ...
              (u.prototype.reparseSeries = function () {
                ...
                if (t) {
                  ...
                  ;(o.update(this.yAxes_[0].options, s.y || {}),
                    this.yAxes_.length > 1 && o.update(this.yAxes_[1].options, s.y2 || {}),
        ...
        function (t, e, a) {
          ...
          var o = function (t, e, a, i, r, o) {
            ...
            for (s = 0; s < p.length; s++)
              void 0 === p[s].label && (p[s].label = C.call(r, p[s].v, 0, i, r))
            return p
          }
          a.numericTicks = o
          ...
          var h = {
            ...
            u = []
          ;((u[l.MILLISECONDLY] = { datefield: h.DATEFIELD_MS, step: 1, spacing: 1 }),
            (u[l.TWO_MILLISECONDLY] = { datefield: h.DATEFIELD_MS, step: 2, spacing: 2 }),
            (u[l.FIVE_MILLISECONDLY] = { datefield: h.DATEFIELD_MS, step: 5, spacing: 5 }),
            (u[l.TEN_MILLISECONDLY] = { datefield: h.DATEFIELD_MS, step: 10, spacing: 10 }),
            (u[l.FIFTY_MILLISECONDLY] = { datefield: h.DATEFIELD_MS, step: 50, spacing: 50 }),
            (u[l.HUNDRED_MILLISECONDLY] = { datefield: h.DATEFIELD_MS, step: 100, spacing: 100 }),
            (u[l.FIVE_HUNDRED_MILLISECONDLY] = {
              datefield: h.DATEFIELD_MS,
              step: 500,
              spacing: 500
            }),
            (u[l.SECONDLY] = { datefield: h.DATEFIELD_SS, step: 1, spacing: 1e3 }),
            (u[l.TWO_SECONDLY] = { datefield: h.DATEFIELD_SS, step: 2, spacing: 2e3 }),
            (u[l.FIVE_SECONDLY] = { datefield: h.DATEFIELD_SS, step: 5, spacing: 5e3 }),
            (u[l.TEN_SECONDLY] = { datefield: h.DATEFIELD_SS, step: 10, spacing: 1e4 }),
            (u[l.THIRTY_SECONDLY] = { datefield: h.DATEFIELD_SS, step: 30, spacing: 3e4 }),
            (u[l.MINUTELY] = { datefield: h.DATEFIELD_MM, step: 1, spacing: 6e4 }),
            (u[l.TWO_MINUTELY] = { datefield: h.DATEFIELD_MM, step: 2, spacing: 12e4 }),
            (u[l.FIVE_MINUTELY] = { datefield: h.DATEFIELD_MM, step: 5, spacing: 3e5 }),
            (u[l.TEN_MINUTELY] = { datefield: h.DATEFIELD_MM, step: 10, spacing: 6e5 }),
            (u[l.THIRTY_MINUTELY] = { datefield: h.DATEFIELD_MM, step: 30, spacing: 18e5 }),
            (u[l.HOURLY] = { datefield: h.DATEFIELD_HH, step: 1, spacing: 36e5 }),
            (u[l.TWO_HOURLY] = { datefield: h.DATEFIELD_HH, step: 2, spacing: 72e5 }),
            (u[l.SIX_HOURLY] = { datefield: h.DATEFIELD_HH, step: 6, spacing: 216e5 }),
            (u[l.DAILY] = { datefield: h.DATEFIELD_D, step: 1, spacing: 864e5 }),
            (u[l.TWO_DAILY] = { datefield: h.DATEFIELD_D, step: 2, spacing: 1728e5 }),
            (u[l.WEEKLY] = { datefield: h.DATEFIELD_D, step: 7, spacing: 6048e5 }),
            (u[l.MONTHLY] = { datefield: h.DATEFIELD_M, step: 1, spacing: 2629817280 }),
            (u[l.QUARTERLY] = { datefield: h.DATEFIELD_M, step: 3, spacing: 216e5 * 365.2524 }),
            (u[l.BIANNUAL] = { datefield: h.DATEFIELD_M, step: 6, spacing: 432e5 * 365.2524 }),
            (u[l.ANNUAL] = { datefield: h.DATEFIELD_Y, step: 1, spacing: 864e5 * 365.2524 }),
            (u[l.DECADAL] = { datefield: h.DATEFIELD_Y, step: 10, spacing: 315578073600 }),
            ...
            g = function (t, e, a, i, r) {
              ...
              if (a <= l.HOURLY)
                for (b < t && ((b += g), (m = new Date(b))); b <= e; )
                  (x.push({ v: b, label: o.call(r, m, a, i, r) }), (b += g), (m = new Date(b)))
              else
                for (
                  b < t && ((_[c] += p), (m = d.makeDate.apply(null, _)), (b = m.getTime()));
                  b <= e;
                )
      ...
      17: [
        function (t, e, a) {
          ...
          function p(t, e) {
            ...
            return Math.abs(t) < 0.001 && 0 !== t ? t.toExponential(a - 1) : t.toPrecision(a)
          }
          function g(t) {
            return t < 10 ? '0' + t : '' + t
          }
          ...
          function x(t) {
            var e, a
            if (
              (-1 == t.search('-') || -1 != t.search('T') || -1 != t.search('Z')) &&
              (a = m(t)) &&
              !isNaN(a)
            )
              return a
            if (-1 != t.search('-')) {
              ...
              8 == t.length
                ? ((e = t.substr(0, 4) + '/' + t.substr(4, 2) + '/' + t.substr(6, 2)), (a = m(e)))
                : (a = m(t))
                  ...
                  (null === e[a]
                    ...
                    : A(e[a])
                      ...
                      : !(function (t) {
                        ...
                        ? (('object' == typeof t[a] && null !== t[a]) || (t[a] = {}), w(t[a], e[a]))
                        : (t[a] = e[a]))
            return t
          }
          function A(t) {
            var e = typeof t
            return (
              ('object' == e || ('function' == e && 'function' == typeof t.item)) &&
              null !== t &&
          ...
          function Y(t, e) {
            ...
            if (
              ((i =
                0 !== t && (Math.abs(t) >= Math.pow(10, r) || Math.abs(t) < Math.pow(10, -n))
                  ? t.toExponential(n)
                  : '' + v(t, n)),
              o || s)
            ) {
              ...
              ;(o && ((l = 1e3), (h = rt)),
                s &&
                  (o && console.warn('Setting both labelsKMB and labelsKMG2. Pick one!'),
                  (l = 1024),
                  (h = ot),
                  (u = st)))
              ...
              if (s) {
                ...
                2 === f.length &&
                  f[1] >= 3 &&
                  f[1] <= 24 &&
                  ((i = f[1] % 3 > 0 ? v(f[0] / F(10, f[1] % 3), n) : Number(f[0]).toFixed(2)),
          ...
          function V(t, e, a) {
            ...
            if (0 === 3600 * l + 60 * h + u + 0.001 * d || e >= G.Granularity.DAILY)
              return g(s) + '&#160;' + lt[o]
          ...
          ;(function (i) {
            ...
            function o(t) {
              ...
              if ('number' != typeof a && !x.isDateLike(a))
                throw new Error('Expected number or date but got ' + typeof a + ': ' + a + '.')
              for (var i = 1; i < e.length; i++) {
                var n = e[i]
                if (null !== n && void 0 !== n && 'number' != typeof n && !x.isArrayLike(n))
                  throw new Error('Expected number or array but got ' + typeof n + ': ' + n + '.')
              }
            }
            Object.defineProperty(a, '__esModule', { value: !0 })
            var s = (function () {
                function t(t, e) {
                  ...
                  try {
                    for (
                      ...
                      !(i = (o = s.next()).done) && (a.push(o.value), !e || a.length !== e);
                      i = !0
                    );
                  } catch (t) {
                    ;((n = !0), (r = t))
            ...
            ;((Q.NAME = 'Dygraph'),
              ...
              (Q.prototype.__init__ = function (t, e, a) {
                ...
                ;((this.maindiv_ = t),
                  ...
                  (this.annotations_ = []),
                  (t.innerHTML = ''),
                  '' === t.style.width && a.width && (t.style.width = a.width + 'px'),
                  '' === t.style.height && a.height && (t.style.height = a.height + 'px'),
                  '' === t.style.height &&
                    0 === t.clientHeight &&
                    ((t.style.height = Q.DEFAULT_HEIGHT + 'px'),
                    '' === t.style.width && (t.style.width = Q.DEFAULT_WIDTH + 'px')),
                ...
                for (
                  ...
                  var s = { plugin: r, events: {}, options: {}, pluginOptions: {} },
                    l = r.activate(this)
              ...
              (Q.prototype.destroy = function () {
                ...
                ;(this.removeTrackedEvents_(),
                  ...
                  x.removeEvent(this.mouseEventElement_, 'mousemove', this.mouseMoveHandler_),
                    ...
                    destroy: function () {
                      ...
                      if (
                        ((t.isZooming || t.isPanning) &&
                          ((t.isZooming = !1), (t.dragStartX = null), (t.dragStartY = null)),
                        t.isPanning)
                      ) {
                ...
                if (null !== t && null !== e)
                  for (r = 1; r <= l; r++)
                    ((o = Q.zoomAnimationFunction(r, l)),
                      (h[r - 1] = [t[0] * (1 - o) + o * e[0], t[1] * (1 - o) + o * e[1]]))
                if (null !== a && null !== i)
                  for (r = 1; r <= l; r++) {
                    o = Q.zoomAnimationFunction(r, l)
              ...
              (Q.prototype.findClosestPoint = function (t, e) {
                for (
                  var a, i, n, r, o, s, l, h = 1 / 0, u = this.layout_.points.length - 1;
                  u >= 0;
                  --u
                )
                  for (var d = this.layout_.points[u], c = 0; c < d.length; ++c)
                    ((r = d[c]),
                      x.isValidPoint(r) &&
                        ((i = r.canvasx - t),
                        (n = r.canvasy - e),
                        (a = i * i + n * n) < h && ((h = a), (o = r), (s = u), (l = r.idx))))
              ...
              (Q.prototype.mouseMove_ = function (t) {
                ...
                if (void 0 !== e && null !== e) {
                  ...
                  h &&
                    o &&
                    h.call(this, t, this.lastx_, this.selPoints_, this.lastRow_, this.highlightSet_)
                }
              }),
              ...
              (Q.prototype.animateSelection_ = function (t) {
                ...
                x.repeatAndCleanup(
                  function (e) {
                    n.animateId == i &&
                      ((n.fadeLevel += t),
                      0 === n.fadeLevel ? n.clearSelection() : n.updateSelection_(n.fadeLevel / 10))
                  },
                  a,
                  30,
                  r
              ...
              (Q.prototype.updateSelection_ = function (t) {
                ...
                if (this.getOption('highlightSeriesOpts')) {
                  ...
                  if (i) {
                    ...
                    ;((i *= t),
                      (a.fillStyle = 'rgba(' + n.r + ',' + n.g + ',' + n.b + ',' + i + ')'),
                  ...
                  for (a.save(), e = 0; e < this.selPoints_.length; e++) {
                    ...
                    if (!isNaN(u.canvasy)) {
                      ...
                      ;(c || (c = x.Circles.DEFAULT),
                        (a.lineWidth = this.getNumericOption('strokeWidth', u.name)),
                        (a.strokeStyle = p),
                        (a.fillStyle = p),
                        c.call(this, this, u.name, a, h, u.canvasy, p, d, u.idx))
                    }
                  }
              ...
              (Q.prototype.setSelection = function (t, e, a) {
                ...
                return (
                  this.selPoints_.length
                    ...
                    : (this.lastx_ = -1),
                  void 0 !== e && (this.highlightSet_ !== e && (i = !0), (this.highlightSet_ = e)),
              ...
              (Q.prototype.predraw_ = function () {
                ...
                ;((this.dataHandler_ = new (this.getHandlerClass_())()),
                  ...
                  this.computeYAxes_(),
                  this.is_initial_draw_ || (this.canvas_ctx_.restore(), this.hidden_ctx_.restore()),
                ...
                for (var e = 1; e < this.numColumns(); e++) {
                  ...
                  ;(this.rollPeriod_ > 1 &&
                    (a = this.dataHandler_.rollingAverage(a, this.rollPeriod_, this.attributes_)),
                  ...
                  isNaN(d) || null === d
                    ? 'none' == i
                      ...
                      : (!(function (e) {
                        ...
                        (d =
                          r && o && 'none' != i
                            ? r.yval + (o.yval - r.yval) * ((u - r.xval) / (o.xval - r.xval))
                            : r && 'all' == i
                              ? r.yval
                              : o && 'all' == i
                                ? o.yval
                ...
                for (a = c; a >= 1; a--)
                  if (this.visibility()[a - 1]) {
                    ...
                    ;(this.getBooleanOption('stackedGraph') &&
                      ...
                      void 0 === u[o] && (u[o] = []),
                      Q.stackPoints_(m, u[o], x, this.getBooleanOption('stackedGraphNaNFill'))),
                      (d[y] = x),
                      (h[a] = m))
                  }
              ...
              (Q.prototype.drawGraph_ = function () {
                ...
                for (var r = this.attr_('labels'), o = 0, s = 1; s < i.length; s++)
                  this.visibility()[s - 1] &&
                    (this.layout_.addDataset(r[s], i[s]), (this.datasetIndex_[s] = o++))
                ...
                if (
                  ...
                  var l = new Date()
                  console.log(
                    this.getStringOption('timingName') + ' - drawGraph: ' + (l - t) + 'ms'
                  )
                }
              }),
              ...
              (Q.prototype.computeYAxes_ = function () {
                var t, e, a
                for (this.axes_ = [], t = 0; t < this.attributes_.numAxes(); t++)
                  ((e = { g: this }),
              ...
              (Q.prototype.computeYAxisRanges_ = function (t) {
                for (
                  ...
                  if ((null !== p && ((e = !1), (n = p / this.plotter_.area.h)), 0 === i.length))
                    h.extremeRange = [0, 1]
                  else {
                    for (var g, f, _ = 1 / 0, v = -1 / 0, y = 0; y < i.length; y++)
              ...
              (Q.prototype.detectTypeFromString_ = function (t) {
                ...
                isNaN(parseFloat(t))
                  ? (e = !0)
                  : 8 == t.length && t > '19700101' && t < '20371231' && (e = !0),
              ...
              (Q.prototype.setXAxisOptions_ = function (t) {
                t
                  ? ((this.attrs_.xValueParser = x.dateParser),
                    ...
                    (this.attrs_.axes.x.axisLabelFormatter = x.dateAxisLabelFormatter))
              ...
              (Q.prototype.parseCSV_ = function (t) {
                ...
                'labels' in this.user_attrs_ ||
                  ((s = 1), (this.attrs_.labels = r[0].split(o)), this.attributes_.reparseSeries())
                for (
                          ...
                          ((e = g[a].split('/')),
                            2 != e.length
                              ? (console.error(
                                ...
                                (f[a] = [0, 0]))
                              : (f[a] = [x.parseFloat_(e[0], c, p), x.parseFloat_(e[1], c, p)]))
              ...
              (Q.prototype.parseArray_ = function (t) {
                ...
                if (x.isDateLike(t[0][0])) {
                  ...
                  for (e = 0; e < t.length; e++) {
                    if (0 === i[e].length)
                      return (console.error('Row ' + (1 + e) + ' of data is empty'), null)
                    if (
                      null === i[e][0] ||
                      'function' != typeof i[e][0].getTime ||
                      isNaN(i[e][0].getTime())
                    )
                      return (console.error('x value in row ' + (1 + e) + ' is not a Date'), null)
                    i[e][0] = i[e][0].getTime()
                  }
                  return i
                }
                return (
                  ...
                  (this.attrs_.axes.x.ticker = v.numericTicks),
                  (this.attrs_.axes.x.axisLabelFormatter = x.numberAxisLabelFormatter),
                  t
                )
              }),
              (Q.prototype.parseDataTable_ = function (t) {
                ...
                for (n = 1; n < e; n++) {
                  ...
                  if ('number' == h) o.push(n)
                    ...
                    if ('string' != h || !this.getBooleanOption('displayAnnotations'))
                      throw new Error(
                ...
                for (n = 0; n < o.length; n++)
                  (d.push(t.getColumnLabel(o[n])), this.getBooleanOption('errorBars') && (n += 1))
                ...
                for (n = 0; n < a; n++) {
                  ...
                  if (void 0 !== t.getValue(n, 0) && null !== t.getValue(n, 0)) {
                    if (
                      ...
                      for (r = 0; r < e - 1; r++)
                        f.push([t.getValue(n, 1 + 2 * r), t.getValue(n, 2 + 2 * r)])
                    else {
                      for (r = 0; r < o.length; r++) {
                        var _ = o[r]
                        if (
                          (f.push(t.getValue(n, _)),
                          l && s.hasOwnProperty(_) && null !== t.getValue(n, s[_][0]))
                        ) {
                          var y = {}
                          ;((y.series = t.getColumnLabel(_)),
                            ...
                            (y.shortText = (function (t) {
                              ...
                              for (t = Math.floor(t / 26); t > 0; )
                                ((e = String.fromCharCode(65 + ((t - 1) % 26)) + e.toLowerCase()),
                                  (t = Math.floor((t - 1) / 26)))
                              return e
                            })(g.length)),
                            (y.text = ''))
              ...
              (Q.prototype.start_ = function () {
                ...
                if (('function' == typeof t && (t = t()), x.isArrayLike(t)))
                  ((this.rawData_ = this.parseArray_(t)),
                    this.cascadeDataDidUpdateEvent_(),
                    this.predraw_())
                else if ('object' == typeof t && 'function' == typeof t.getColumnRange)
                  (this.parseDataTable_(t), this.cascadeDataDidUpdateEvent_(), this.predraw_())
                  ...
                  if (e) this.loadedEvent_(t)
                    ...
                    ;((a.onreadystatechange = function () {
                      4 == a.readyState &&
                        ((200 !== a.status && 0 !== a.status) || i.loadedEvent_(a.responseText))
                    }),
                      a.open('GET', t, !0),
                      a.send(null))
                  }
              ...
              (Q.prototype.setVisibility = function (t, e) {
                var a = this.visibility(),
                  i = !1
                if (
                  (Array.isArray(t) || (null !== t && 'object' == typeof t ? (i = !0) : (t = [t])),
                  i)
                )
                  for (var n in t)
                    t.hasOwnProperty(n) &&
                      (n < 0 || n >= a.length
                        ? console.warn('Invalid series number in setVisibility: ' + n)
                        : (a[n] = t[n]))
                else
                  for (var n = 0; n < t.length; n++)
                    'boolean' == typeof t[n]
                      ? n >= a.length
                        ...
                        : (a[n] = t[n])
                      : t[n] < 0 || t[n] >= a.length
                        ? console.warn('Invalid series number in setVisibility: ' + t[n])
                        : (a[t[n]] = e)
                this.predraw_()
              }),
              ...
              (Q.nonInteractiveModel = Q.nonInteractiveModel_ = f.default.nonInteractiveModel_),
              (Q.Circles = x.Circles),
              (Q.Plugins = {
                Legend: U.default,
                Axes: X.default,
                ...
                for (
                  ...
                  if (
                    ...
                    ;(h.hasOwnProperty('icon') ||
                      (c += ' dygraphDefaultAnnotation dygraph-default-annotation'),
                    ...
                    if (h.hasOwnProperty('icon')) {
                      ...
                      l.annotation.hasOwnProperty('shortText') &&
                        d.appendChild(document.createTextNode(l.annotation.shortText))
                    var _ = l.canvasx - p / 2
                    d.style.left = _ + 'px'
                    var v = 0
                    if (h.attachAtBottom) {
              ...
              if (
                ...
                if (r.getOptionForAxis('drawAxis', 'y')) {
                  if (_.yticks && _.yticks.length > 0) {
                    ...
                    _.yticks.forEach(function (t) {
                      if (void 0 !== t.label) {
                        ...
                        var r = l - n / 2
                        ;(r < 0 && (r = 0),
                          r + n + 3 > c ? (o.style.bottom = '0') : (o.style.top = r + 'px'),
                          0 === t.axis
                            ? ((o.style.left =
                                v.x - a('axisLabelWidth') - a('axisTickSize') + 'px'),
                              (o.style.textAlign = 'right'))
                            : 1 == t.axis &&
                              ((o.style.left = v.x + v.w + a('axisTickSize') + 'px'),
                  ...
                  ;((h.strokeStyle = r.getOptionForAxis('axisLineColor', 'y')),
                    ...
                    h.stroke(),
                    2 == r.numAxes() &&
                      ((h.strokeStyle = r.getOptionForAxis('axisLineColor', 'y2')),
                    ...
                    _.xticks.forEach(function (t) {
                      if (void 0 !== t.label) {
                        ...
                        ;(e + D('axisLabelWidth') > d &&
                          ((e = d - D('axisLabelWidth')), (o.style.textAlign = 'right')),
      ...
      22: [
        function (t, e, a) {
          ...
          i.prototype.detachLabels_ = function () {
            for (
              var t = [this.title_div_, this.xlabel_div_, this.ylabel_div_, this.y2label_div_],
                e = 0;
              e < t.length;
              e++
            ) {
          ...
          var r = function (t, e, a, i, n) {
            ...
            ;((o.style.position = 'absolute'),
              ...
              (o.className = 'dygraph-label-rotate-' + (1 == a ? 'right' : 'left')))
          ...
          ;((i.prototype.layout = function (t) {
            ...
            if (e.getOption('title')) {
              ...
              ;((this.title_div_ = n(i)),
                (this.title_div_.style.fontSize = e.getOption('titleHeight') - 8 + 'px'))
              var o = document.createElement('div')
            ...
            if (e.getOption('xlabel')) {
              ...
              ;((this.xlabel_div_ = n(s)),
                (this.xlabel_div_.style.fontSize = e.getOption('xLabelHeight') - 2 + 'px'))
              var o = document.createElement('div')
            ...
            (i.prototype.didDrawChart = function (t) {
              var e = t.dygraph
              ;(this.title_div_ && (this.title_div_.children[0].innerHTML = e.getOption('title')),
                this.xlabel_div_ &&
                  (this.xlabel_div_.children[0].innerHTML = e.getOption('xlabel')),
                this.ylabel_div_ &&
                  (this.ylabel_div_.children[0].children[0].innerHTML = e.getOption('ylabel')),
                this.y2label_div_ &&
                  (this.y2label_div_.children[0].children[0].innerHTML = e.getOption('y2label')))
            }),
      ...
      24: [
        function (t, e, a) {
          ...
          function i(t, e, a) {
            if (!t || t.length <= 1)
              return (
                '<div class="dygraph-legend-line" style="border-bottom-color: ' + e + ';"></div>'
              )
            var i,
              n,
              r,
          ...
          ;((o.prototype.toString = function () {
            ...
            (o.prototype.activate = function (t) {
              ...
              return (
                a && null !== a
                  ? (e =
                      'string' == typeof a || a instanceof String ? document.getElementById(a) : a)
          ...
          var s = function (t) {
              ...
              ;(e.setAttribute('style', 'margin: 0; padding: 0 0 0 1em; border: 0;'),
                t.appendChild(e))
              var a = e.offsetWidth
          ...
          ;((u.prototype.toString = function () {
            ...
            (u.prototype.reserveSpace_ = function (t) {
              this.getOption_('showRangeSelector') &&
                t.reserveSpaceBottom(this.getOption_('rangeSelectorHeight') + 4)
            }),
            ...
            (u.prototype.updateVisibility_ = function () {
              ...
              if (t)
                this.interfaceCreated_
                  ? (this.graphDiv_ && this.graphDiv_.parentNode) || this.addToGraph_()
                  : this.createInterface_()
            ...
            (u.prototype.initInteraction_ = function () {
              ...
              ;((t = function (t) {
                ...
                (e = function (t) {
                  return (
                    ...
                    ('mousedown' !== t.type && 'dragstart' !== t.type) ||
                      (r.addEvent(y, 'mousemove', a), r.addEvent(y, 'mouseup', i)),
                ...
                (l = function (t) {
                  return (
                    ...
                    (x = t.clientX),
                    'mousedown' === t.type &&
                      (r.addEvent(y, 'mousemove', u), r.addEvent(y, 'mouseup', d)),
                    !0)
                  )
                }),
                (u = function (t) {
                ...
                (_ = function (t, e) {
                  for (
                    var a = ['touchstart', 'touchend', 'touchmove', 'touchcancel'], i = 0;
                    i < a.length;
                    i++
                  )
                    v.dygraph_.addAndTrackEvent(t, a[i], e)
                }),
                this.setDefaultOption_('interactionModel', s.default.dragIsPanInteractionModel),
              ...
              ;(this.dygraph_.addAndTrackEvent(this.leftZoomHandle_, D, e),
                ...
                this.hasTouchInterface_ &&
                  (_(this.leftZoomHandle_, g), _(this.rightZoomHandle_, g), _(this.fgcanvas_, f)))
            }),
            (u.prototype.drawStaticLayer_ = function () {
              ...
              ;((this.bgcanvas_ctx_.lineWidth = this.getOption_(
                ...
                (t.strokeStyle = this.getOption_('rangeSelectorBackgroundStrokeColor')),
                t.beginPath(),
                t.moveTo(0.5, 0.5),
                  ...
                  ;(i || null === p || Math.round(v) != Math.round(p)) &&
                    (isFinite(v) && isFinite(y)
                      ? (null === p ? o.lineTo(v, c) : i && o.lineTo(v, g),
                        ...
                        (p = v),
                        (g = y))
                      : (null !== p && (i ? (o.lineTo(v, g), o.lineTo(v, c)) : o.lineTo(p, c)),
                        (p = g = null)))
                }
            ...
            (u.prototype.computeCombinedSeriesAndLimits_ = function () {
              ...
              if (a)
                for (b = r.log10(b), b += 0.25 * b, m = r.log10(m), t = 0; t < f.length; t++)
                  f[t][1] = r.log10(f[t][1])
              else {
                var A,
                  O = b - m
                ;((A = O <= Number.MIN_VALUE ? 0.25 * b : 0.25 * O), (b += A), (m -= A))
              }
            ...
            (u.prototype.drawInteractiveLayer_ = function () {
              ...
              if (
                ((t.strokeStyle = this.getOption_('rangeSelectorForegroundStrokeColor')),
                (t.lineWidth = this.getOption_('rangeSelectorForegroundLineWidth')),
                i.isZoomed)
              ) {
            ...
            (u.prototype.getZoomHandleStatus_ = function () {
              ...
              return {
                ...
                rightHandlePos: a,
                isZoomed:
                  e - 1 > this.canvasRect_.x || a + 1 < this.canvasRect_.x + this.canvasRect_.w
              }
            }),
            (a.default = u),
            (e.exports = a.default))
