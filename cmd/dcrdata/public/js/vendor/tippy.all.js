;(function (t, e) {
  ...
  function l(t, e, a, i) {
    ...
    return (
      i.target
        ? (qt.supportsTouch && i.touchHold && (d('touchstart', n), d('touchend', s)),
          'mouseenter' === t && (d('mouseover', n), d('mouseout', s)),
          'focus' === t && (d('focusin', n), d('focusout', s)),
          'click' === t && d('click', n))
        : (d(t, o),
          qt.supportsTouch && i.touchHold && (d('touchstart', o), d('touchend', r)),
  ...
  function $() {
    this.state.eventsEnabled &&
      (cancelAnimationFrame(this.scheduleUpdate), (this.state = Z(this.reference, this.state)))
  }
  function tt(t) {
  ...
  function nt(t, e, a, i) {
    ...
    var s = /\s*,\s*|\s+/,
      l =
        -1 === n
          ? [p]
          : [p.slice(0, n).concat([p[n].split(s)[0]]), [p[n].split(s)[1]].concat(p.slice(n + 1))]
    return (
  ...
  function bt(t, e, a) {
    var i = ct(t),
      ...
      c = a
        ...
        .replace(
          l.scale,
          'scale' + ht(d.scale.axis, o) + '(' + ft('scale', d.scale.numbers, o, r) + ')'
        )
    ...
    if (
      (this.popperInstance
        ? (this.popperInstance.scheduleUpdate(),
          e.livePlacement && !Et.call(this) && this.popperInstance.enableEventListeners())
  ...
  function _t(t, e) {
    return t.reduce(function (t, a) {
      ...
      o.createPopperInstanceOnInit &&
        ((n.popperInstance = Ct.call(n)), n.popperInstance.disableEventListeners())
      var h = At.call(n)
      return (
            ...
            var l = e.priority,
              ...
              c = {
                primary: function (t) {
                  var a = d[t]
                  return (
                    d[t] < s[t] && !e.escapeWithReference && (a = Ut(d[t], s[t])),
                    ne({}, t, a)
                  )
                },
                secondary: function (t) {
                  ...
                  return (
                    d[t] > s[t] &&
                      ...
                      (i = Mt(d[a], s[t] - ('right' === t ? d.width : d.height))),
                    ne({}, a, i)
                  )
                }
              }
                            ...
                            d &&
                              e
                                ...
                                .followCursorListener(
                                  r && e._(be).lastMouseMoveEvent ? e._(be).lastMouseMoveEvent : d
                                )
                          }
                          ;(vt([n, s, s ? l : null], t),
                    ...
                    Dt.call(e, t, function () {
                      e.state.visible ||
                        ...
                        (!e._(be).isPreparingToShow &&
                          (document.removeEventListener('mousemove', e._(be).followCursorListener),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!this.state.destroyed) {
                ...
                ;(['data-original-title', 'data-tippy', 'data-tippy-delegate'].forEach(
                  function (e) {
