  ...
  return (function (t) {
    ...
    function (t, e, r) {
      function n(t) {
        ...
        if (((t.xdomain = r), (t.xscheme = n), (e = new o(t)), 'open' in e && !t.forceJSONP))
          return new i(t)
    ...
    function (t, e, r) {
      ...
      function o(t) {
        if (
          ...
          ;(r || (r = e ? 443 : 80),
            (this.xd =
              ('undefined' != typeof location && t.hostname !== location.hostname) || r !== t.port),
            (this.xs = t.secure !== e))
        }
      }
      function i(t) {
    ...
    function (t, e, r) {
      ...
      ;((e.encodePacket = function (t, e, r, i) {
        ...
        var c = v[t.type]
        return (
          void 0 !== t.data && (c += r ? d.encode(String(t.data), { strict: !1 }) : String(t.data)),
          i('' + c)
        )
      }),
    ...
    function (t, e) {
      ...
      function s(t, e) {
        ...
        return (
          0 == (4294965248 & t)
            ? (r = d(((t >> 6) & 31) | 192))
            : 0 == (4294901760 & t)
              ? (o(t, e) || (t = 65533), (r = d(((t >> 12) & 15) | 224)), (r += i(t, 6)))
              : 0 == (4292870144 & t) &&
      ...
      function p(t) {
        ...
        if (224 == (240 & e)) {
          if (((r = c()), (n = c()), (s = ((15 & e) << 12) | (r << 6) | n), s >= 2048))
